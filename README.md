...
| RN10 | Estático | O Sistema deve cachear consultas frequente de mais de utilizando Redis para reduzir o tempo de acesso ao banco de dados | 
| RN11 | Estático |  O Sistema deve utilizar o banco de dados para armazenar informações |
| RN12 | Estático |  O Tamanho total do sistema não deve ser maior que 100 mBytes |
| RN13 | Estático | O Sistema deve suportar inicialmente pelo menos 500.000 usuarios concorrentemente |
| RN14 | Estático | O Sistema deve estar disponivel 90% das vezes |
| RN15 | Estático | O
| RN16| Estático|  O Sistema deve utilizar o banco de dados para armazenar informações |
| RN17| Estático|  O Sistema deve utilizar uma Interface Gráfica para exibir informações |
